...
if y_arr.size > 1:
    ...
    for y in y_arr:
        ...
        tl.tower_avaliable_name(i)
        tow = tl.tow.copy()

        j += 1
        
        # Loop through all the available towers and call the extraction module and concatenate the data in order, using time as index, in each one of them
        for x in tow:
