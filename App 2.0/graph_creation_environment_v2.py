...
towers = np.array(["tnw01", "tnw09", "tnw13", "rsw01", "rsw02", "v03"])#, "tnw09", "tnw10"])#"tnw01", "tnw02", "tnw03", "tnw04", "tnw05"])#, "tnw06", "tnw07", "tnw08", "tnw09", "tnw10"])#
#heights_def = np.array([2])
he_def = 0
...
if towers.size == 1:
    ...
    if table_bias == 1:
        ...
        df_bias, bias_v = gf.tab_bias_v(bias, bias_var,nhour,heights)
        gf.save_rmse_table(df_bias,path_pf,bias_var,a_name,b_name,c_name,towers)
