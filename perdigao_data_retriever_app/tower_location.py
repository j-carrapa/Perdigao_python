...
def coordinates_file_creation(main_direc):
    '''Takes none, Returns data frame containing all sonics coordinates (PT-TM06/ETRS89, height, sonic name) (Pandas Data Frame)'''
    file_path = di.raw_files_directory(main_direc)
    file_name = r'{}\Relatorio_sonics_data.xlsx'.format(file_path)
    sheet =  'Sheet1'
    ...
    df2 = pd.read_csv(r'{}\sonics_coord_corrected.csv'.format(file_path))
