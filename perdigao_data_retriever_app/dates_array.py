...
def dates_16_function ():
    '''Takes none, Returns array with the available dates for 2016 (np array of int)'''
...
def dates_tot_function ():
    '''Takes none, Returns array with all the available dates (np array of int)'''
    dates = dates_16_function()
